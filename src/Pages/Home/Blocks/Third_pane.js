...
import blackMobile from  '../../../images/black-mobile.png'

const Third_Pane = ()=>{
    return(
        <div>

        <div className="uk-margin-large-top uk-visible@s">
...
<div className="uk-margin-large-top uk-hidden@s">
            <div className="uk-container"
              style={{ backgroundImage: `url(${blackMobile})`,
              backgroundRepeat: 'no-repeat',
              backgroundSize: 'cover',
              paddingBottom: '80px',
              height:'65vh'
                  ...
                  <div className="uk-grid" data-uk-grid>
                      <div className="uk-width-1-2@s">
                           <div className="uk-margin-large-top uk-padding">
                            ...
                            <p className="light uk-margin-medium-top uk-text-left">Work with the largets network of independent professionals
                              and get things done-from quick turnarounds to big transformations</p>
                           </div>
                      </div>
